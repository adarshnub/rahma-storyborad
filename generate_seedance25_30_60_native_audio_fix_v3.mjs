...
const outputDir = path.join(root, "generated-video", "seedance25-30-60s-native-audio-fix-v3");
...
AUDIO: Generate native synchronized audio with the same warm, mature Emirati male off-screen narrator style used in the approved first 30 seconds: warm, natural, grounded English delivery, one uninterrupted speaker for the complete 30 seconds. No on-screen speaker or lip-sync. Do not rush, truncate, interrupt, overlap, replace, paraphrase, or skip any word. Pronounce all English exactly and clearly. In particular, say the phrase "People of Determination" exactly as written, in clear English; do not substitute another word and do not pronounce it as a different phrase.

Use this exact spoken script and timing; spoken lines may continue naturally over a black/title hold so that the sentence completes. Do not force any line to end at a visual-card boundary:
00:00-00:11.8: "For people with disabilities, it changed the word. People of Determination. For the elderly, it changed the word again. Senior Citizens. A nation is measured by what it calls the people it protects."
00:13.0-00:20.8: "There is one more word. Rahma. It is not a word this country borrowed. It is the one it was built on."
00:22.6-00:26.4: "And now it is something you can hold in your hand."

Audio must remain continuous and clean through local 00:21; do not cut off, restart, stutter, change speaker, or place an edit on the word Rahma. Sound bed: restrained warm strings under the first line, then a held note falls away before the second line. A low warm bed returns only beneath the last line and phone wake. No whooshes, percussion, risers, impacts, alarms, crowd ambience, room dialogue, pen/signing foley, or other mechanical foley.`;
...
const requestBody = { model: MODEL, content, resolution: "720p", ratio: "16:9", duration: 30, generate_audio: true, watermark: false, seed: 19711205, omni_reference_task_type: "reference" };
