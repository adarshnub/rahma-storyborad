...
const partTwoFrames: Record<string, StoryFrame[]> = {
  ...
  "15": buildPartTwoFrames("moment-03-ahmed-night", [["02:12", "02-12-title-card-black.png", "A Tuesday night"], ["02:13", "02-13-ahmed-asleep.png", "Ahmed asleep"], ["02:14", "02-14-ahmed-home-detail.png", "His own home"], ["02:15", "02-15-ahmed-wakes.png", "Cardiac distress"], ["02:16", "02-16-ahmed-looks-phone.png", "Watch detects it"], ["02:17", "02-17-ahmed-reaches-phone.png", "Rahma activates on watch"], ["02:18", "02-18-thumb-hold.png", "Phone wakes automatically"], ["02:19", "02-19-thumb-hold-one.png", "Watch-to-phone connection"], ["02:20", "02-20-thumb-hold-two.png", "Rahma continues automatically"], ["02:21", "02-21-ahmed-composed.png", "Ahmed does not need the phone"]]),
  "16": buildPartTwoFrames("moment-03-ahmed-night", [["02:22", "02-22-daughter-table.png", "Daughter's phone wakes"], ["02:23", "02-23-daughter-phone.png", "She understands"], ["02:24", "02-24-daughter-understands.png", "She understands"], ["02:25", "02-25-daughter-keys.png", "Keys"], ["02:26", "02-26-daughter-leaves.png", "Leaving calmly"], ["02:27", "02-27-daughter-car.png", "Focused journey"], ["02:28", "02-28-building-corridor.png", "Building corridor"], ["02:29", "02-29-paramedics-with-ahmed.png", "Care already there"]]),
...
const clips: Clip[] = [
  {
    ...
    video: { src: "/generated-video/first30-curated-audio-final/rahma-first30-curated-audio-final.mp4", poster: "/generated-video/first30-curated-audio-final/poster.png", label: "Seedance 2.5 · Combined Clips 01–03 · face-visible revision · 30 sec · 720p · native audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Face-visible continuity revision with the original native narration restored. The visual edit is unchanged." } }
  },
  {
  ...
  },
  {
    ...
    video: { src: "/generated-video/30-60s-native-audio-fix-final/rahma-30-60s-native-audio-fix-final.mp4", poster: "/generated-video/30-60s-native-audio-fix-final/poster.png", label: "Seedance 2.5 · Clips 04–06 · native narration correction · 30 sec · 720p", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Native-narration correction: explicit People of Determination pronunciation and uninterrupted Rahma timing. Approved title, wordmark, Mariam framing, room, phone and RAHMA hold button are unchanged." } }
  },
  {
  ...
  },
  {
    ...
    video: { src: "/generated-video/60-90s-curated-final/rahma-60-90s-curated-final.mp4", poster: "/generated-video/60-90s-curated-final/poster.png", label: "Seedance 2.5 · Clips 07–09 · English native narration correction · 30 sec · 720p", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "English-only native narration correction, transcript verified. Mariam remains alone for the hold; the quiet care-notification chain retains full visible faces and no emergency-vehicle spectacle." } }
  },
  {
  ...
  { id: "11", title: "The child — Rahma response", range: "01:36 — 01:46", section: "Moments", source: "Use 01:36–01:46.", beat: "A worried Emirati teenager triggers Rahma from a safe corridor during a building fire response.", voiceover: "A building emergency. One boy, safe enough to ask for help.", sound: "Building alert ambience and a restrained confirmation tone. No siren foreground.", refs: ["PART 2 / TEEN + FAMILY + FIRE-RESCUE"], prompt: "Use the approved Emirati teenager, family and fire-rescue continuity board. Keep the teenager physically safe.", first: "Black title card.", last: "Parents arrive outside.", bridge: "Continue with the safe handover.", frames: partTwoFrames["11"], video: { src: "/generated-video/child-11-12-english-final/rahma-child-11-12-english-final.mp4", poster: "/generated-video/child-11-12-english-final/poster.png", label: "Seedance 2.5 · Clips 11–12 · urgent fire response · 30 sec · 720p · English audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Urgent fire-story correction: frightened Yousef activates Rahma, a fire engine responds with siren, firefighters guide him, then he reaches his family safe." } } },
  { id: "12", title: "The child — family handover", range: "01:46 — 01:54", section: "Moments", source: "Editorially trimmed to 8 seconds.", beat: "The parents, fire-rescue team and teenager complete a calm, safe handover outside the building.", voiceover: "Help is already on its way. His family reaches him safe.", sound: "Quiet response ambience and family relief; no siren foreground.", refs: ["PART 2 / TEEN + FAMILY + FIRE-RESCUE"], prompt: "Keep the family and rescue response composed; no injury, crowd or spectacle.", first: "Parents check in.", last: "Relieved family connection.", bridge: "Cut to black for Lina's morning.", frames: partTwoFrames["12"], video: { src: "/generated-video/child-11-12-english-final/rahma-child-11-12-english-final.mp4", poster: "/generated-video/child-11-12-english-final/poster.png", label: "Seedance 2.5 · Clips 11–12 · urgent fire response · 30 sec · 720p · English audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Urgent fire-story correction: frightened Yousef activates Rahma, a fire engine responds with siren, firefighters guide him, then he reaches his family safe." } } },
  { id: "13", title: "The medicine — setup", range: "01:54 — 02:04", section: "Moments", source: "Use full 10 seconds.", beat: "Amina's routine refill arrives before it becomes a problem, without asking her to leave home.", voiceover: "Amina has insulin for nine more days. Nobody has fallen. Nothing has gone wrong. Rahma noticed nine days ago.", sound: "Tea, plant water and a soft doorbell.", refs: ["PART 2 / AMINA WHEELCHAIR CONTINUITY", "EMIRATI SUPPORT CAST"], prompt: "Amina is an authentic Emirati permanent wheelchair user: she remains visibly seated in the locked manual wheelchair, never standing or walking. Routine prevention only; no medical drama.", first: "Black title card.", last: "Amina receives the bag at seated height.", bridge: "Continue into the proof of stillness.", frames: partTwoFrames["13"], video: { src: "/generated-video/medicine-13-14-english-final/rahma-medicine-13-14-english-final.mp4", poster: "/generated-video/medicine-13-14-english-final/poster.png", label: "Seedance 2.5 · Clips 13–14 · medicine story · 30 sec · 720p · English audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Medicine continuity correction: Amina remains seated in her wheelchair; the refill alert and accessible delivery lead into quiet proof." } } },
  { id: "14", title: "The medicine — proof", range: "02:04 — 02:12", section: "Moments", source: "Editorially trimmed to 8 seconds.", beat: "Nothing happens today. That is the proof.", voiceover: "Nothing happens today. That is the point.", sound: "Tea, paper and morning room tone.", refs: ["PART 2 / AMINA WHEELCHAIR CONTINUITY"], prompt: "Hold ordinary, capable domestic calm. Amina remains seated in the locked wheelchair wherever she appears; no interruption.", first: "Bag beside her chair.", last: "Tea stays still.", bridge: "Cut to black for Ahmed's night.", frames: partTwoFrames["14"], video: { src: "/generated-video/medicine-13-14-english-final/rahma-medicine-13-14-english-final.mp4", poster: "/generated-video/medicine-13-14-english-final/poster.png", label: "Seedance 2.5 · Clips 13–14 · medicine story · 30 sec · 720p · English audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Medicine continuity correction: Amina remains seated in her wheelchair; the refill alert and accessible delivery lead into quiet proof." } } },
  { id: "15", title: "The night — recognition", range: "02:12 — 02:22", section: "Moments", source: "Use full 10 seconds.", beat: "Ahmed's wearable detects acute cardiac distress and activates Rahma before he can ask for help. His nearby phone mirrors the app automatically; he never touches it.", voiceover: "Ahmed is eighty-one. He lives alone, and he prefers it that way.", sound: "One lamp, television murmur and a restrained watch confirmation tone.", refs: ["PART 2 / AHMED", "REF-04 WEARABLE + PHONE"], prompt: "Show medically clear but non-graphic cardiac distress: conscious, seated, shallow breathing, sweat and a hand to chest. The exact Rahma watch detects and activates automatically, then the untouched nearby graphite phone mirrors the locked Rahma app. No fall, phone handling, siren or medical spectacle.", first: "Black title card.", last: "Ahmed supported by automatic Rahma response.", bridge: "Cut to the daughter as her untouched phone receives the same Rahma state.", frames: partTwoFrames["15"], video: { src: "/generated-video/ahmed-15-16-english-final/rahma-ahmed-15-16-english-final.mp4", poster: "/generated-video/ahmed-15-16-english-final/poster.png", label: "Seedance 2.5 · Clips 15–16 · night recognition · 30 sec · 720p · English audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Hands-free cardiac-recognition correction: Ahmed never touches the phone; his wearable activates Rahma and care reaches him." } } },
  { id: "16", title: "The night — connection", range: "02:22 — 02:30", section: "Moments", source: "Editorial 8-second use.", beat: "Ahmed's daughter's untouched phone wakes automatically to Rahma; she understands and arrives while calm care is already present.", voiceover: "He was never on his own. Not for one minute.", sound: "A restrained phone confirmation tone, keys, room tone and quiet relief. No siren.", refs: ["PART 2 / AHMED + DAUGHTER", "REF-04 WEARABLE + PHONE", "EMIRATI PARAMEDICS"], prompt: "The daughter's phone activates itself with the locked Rahma app while she is setting the table; she does not touch it until after she understands. Connection, not rescue spectacle; end just before the close montage.", first: "Untouched Rahma phone wakes on the counter.", last: "Care already there.", bridge: "The close montage begins at 02:30.", frames: partTwoFrames["16"], video: { src: "/generated-video/ahmed-15-16-english-final/rahma-ahmed-15-16-english-final.mp4", poster: "/generated-video/ahmed-15-16-english-final/poster.png", label: "Seedance 2.5 · Clips 15–16 · night recognition · 30 sec · 720p · English audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "Hands-free cardiac-recognition correction: Ahmed never touches the phone; his wearable activates Rahma and care reaches him." } } },
  { id: "17", title: "Close — Rahma", range: "02:30 — 02:50", section: "Close", source: "Use full 20 seconds.", beat: "A slow human montage resolves into silence, the Arabic word, Rahma, logo, then black.", voiceover: "This country was built on a promise — that no one here would be left to manage alone. In this country, someone is always thinking about the people who cannot always ask. There is a word for that.", sound: "Music thins to a single line, then silence. No effects.", refs: ["PART 2 / CHILD FAMILY", "PART 2 / AMINA", "PART 2 / AHMED + DAUGHTER"], prompt: "Hold the quiet montage longer than comfortable. Use only established Emirati characters; exact Arabic and logo cards are compositor-supplied. End on true black.", first: "Teenager safe with his parents.", last: "Black.", bridge: "End.", frames: partTwoFrames["17"], video: { src: "/generated-video/close-17-english-final/rahma-close-17-final.mp4", poster: "/generated-video/close-17-english-final/poster.png", label: "Seedance 2.5 · Clip 17 · close montage · 20 sec · English audio", approval: "awaiting-review", cost: { budgetUsd: 6.05, spentUsd: 6.05, status: "Approved Arabic Rahma wordmark and logo composited into the final silent beats; ends on true black." } } }
];
    ...
    <main>
      ...
      <header className="topbar">
        ...
        <div className="topbar-downloads">
          <a className="download" href="/generated-video/final-film/rahma-final-film.mp4" download>Download final film <Icon name="arrow" /></a>
