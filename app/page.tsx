...
const clips: Clip[] = [
  ...
  },
  {
    ...
    video: { src: "/generated-video/30-60s-curated-final/rahma-30-60s-curated-final.mp4", poster: "/generated-video/30-60s-curated-final/poster.png", label: "Seedance 2.5 · Clips 04–06 · curated continuity revision · 30 sec · 720p · native audio", approval: "awaiting-review", cost: { budgetUsd: 9.07, spentUsd: 9.07, status: "8 curated scenario references—not a 1-FPS conditioning pack. The title and wordmark treatment are retained, and Mariam's privacy-safe back/hand framing, room, phone and RAHMA hold button stay locked." } }
  },
  {
