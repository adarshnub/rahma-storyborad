...
const outputDir = path.join(root, "generated-video", "seedance25-first30-curated-audio-v3");
...
- The Clip 02 archive is a photoreal monochrome-sepia 1971-era UAE founding meeting: mature Emirati/Gulf Arab men in white kanduras and ghutras at a walnut table with cream documents and warm window light. It must match the established documentary archive look, not illustration, painting, graphic art, or a new visual style. Frame the men in frontal or clean three-quarter angles so every person facing camera has a fully unobstructed, readable face. Never show backs of heads or faces covered by the ghutra.
- Images 4-6 are the authority for their three present-day Clip 02 details respectively: school gate, hospital corridor, and elderly hands with tea. Preserve their contemporary UAE/GCC material and human-scale continuity. Do not bring archival props into them.
- Image 7 is the authority for Clip 03's matte-black bilingual child-law title-card layout. Keep it faithful and still; no other graphic motif.
...
00:10-00:18 - Clip 02 archive: intimate photoreal founding-era meeting in the established sepia documentary style. Make a gentle respectful push toward men with faces fully turned to camera and unobstructed. No ceremonial wide shot, no backs to camera, and no concealed faces.
...
00:22-00:29 - Clip 03: child-law title card from Image 7, held absolutely still on matte black.
